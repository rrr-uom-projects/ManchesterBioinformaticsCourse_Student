...
fig, ax = plt.subplots()
plt.imshow(img1_array, alpha=0.5, cmap="Greys_r") # plot the images with transparency (alpha)
...
def cost(image_1, image_2):
    N = (image_1.shape[0])*(image_1.shape[1]) # calculate number of pixels to calculate mean squared error
...
print(registerImages([3, -25], img1_array, img2_array)) # print the cost value for the registered image1 and image2
