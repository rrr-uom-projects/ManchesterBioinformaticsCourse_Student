...
#Function to register image and return value of cost function metric
...
#registering_shift = differential_evolution(register_images, ((-100, 100),(-100,
#100)), args=(fixed, floating))
#print(registering_shift['x'])

#Assign floating images
floating_list = [image2_array, image3_array, image4_array]

#Find optimal registrations for each imahe with respect to image 1
...
#Apply the optimal shift to each respective image
shifted_images = []
i=0
...
#The brute and differential_evolution optimisers give very similar results
